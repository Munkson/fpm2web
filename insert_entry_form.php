...
<link rel="stylesheet" type="text/css" href="fpm2web.css">
    <title>FPM2 Web : exported entry insert form</title>
<script>
...
<body onLoad="initForm();">
  ...
  <h1 class="software_name">FPM2 Web</h1>
          <h2 class="software_function">FPM2 exported file edit &gt; insert entry</h2>
...
<?php } ?>
      <div class="inputform">
      <form action="insert_entry.php" method="POST" id="update_form">
      <dl>
      ...
      <dt><label for="position">Position: </label></dt><dd><input type="text" id="position" name="n" size="4" value="<?= htmlspecialchars($n, ENT_HTML5, "UTF-8") ?>" ></dd>
      </dl>
